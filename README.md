...
## Available tags:
#### 5.X
- **5.11-alpine**, **5-alpine**, **alpine**, **5.11**, **5**, **latest** ![](https://img.shields.io/docker/image-size/traccar/traccar/5.11-alpine)
- **5.11-debian**, **5-debian**, **debian** ![](https://img.shields.io/docker/image-size/traccar/traccar/5.11-debian)
- **5.11-ubuntu**, **5-ubuntu**, **ubuntu** ![](https://img.shields.io/docker/image-size/traccar/traccar/5.11-ubuntu)
- _..._
